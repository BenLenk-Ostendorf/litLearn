...
export default function AiSuggestion({ suggestion, onAdopt, onDismiss }) {
  ...
  return (
    <div className="mt-3 p-3 bg-ai-suggestion rounded-lg border border-ai-border">
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        className="w-full flex items-center justify-between hover:bg-purple-50 rounded p-1 transition-colors"
      >
