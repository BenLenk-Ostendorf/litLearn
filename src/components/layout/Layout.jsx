      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            Wähle den Projektordner aus, in dem deine Paper-Daten gespeichert werden sollen.
          </p>
          <button
          ...
          <p className="text-sm text-gray-500 mt-4">
            Benötigt Chrome oder Edge Browser
          </p>
        </div>
      </div>
    )
        ...
        {error && (
          <div className="mx-6 mt-4 bg-error/10 border border-error/20 rounded-lg p-4 flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-error font-medium">Fehler</p>
